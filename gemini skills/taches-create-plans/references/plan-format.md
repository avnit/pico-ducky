...
See: references/cli-automation.md for what gemini can automate.
...
**Golden rule:** If gemini CAN automate it, gemini MUST automate it. See: references/cli-automation.md
