...
ROADMAP.md        ← Structure (phases)
    ↓
phases/XX/PLAN.md ← Implementation (gemini-executable)
    ↓
...
**Audience**: Both human and gemini
...
**Purpose**: Define gemini-executable tasks
**Audience**: gemini (the implementer)
...
**Audience**: gemini (via create-meta-prompts)
...
<cross_phase_context>
When planning Phase N, gemini should understand:
