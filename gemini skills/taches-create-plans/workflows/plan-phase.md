...
7. Read domain SKILL.md: `~/.gemini/skills/expertise/[domain]/SKILL.md`
...
**Key insight:** PLAN.md IS the prompt that gemini executes. Not a document that
...
- gemini automated work needing visual/functional verification? → checkpoint:human-verify
...
<execution_context>
@~/.gemini/skills/create-plans/workflows/execute-phase.md
@~/.gemini/skills/create-plans/templates/summary.md
[If plan has ANY checkpoint tasks (type="checkpoint:*"), add:]
@~/.gemini/skills/create-plans/references/checkpoints.md
</execution_context>
