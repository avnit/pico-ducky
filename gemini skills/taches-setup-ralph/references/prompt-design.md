...
Gemini Code can spawn hundreds of subagents for reading/searching. Use this:

```markdown
Study specs/* (up to 500 parallel Sonnet subagents)
```

This tells gemini it's safe and encouraged to use massive parallelism.
...
Gemini Code is conservative about spawning subagents unless explicitly permitted. Specifying counts signals:
...
gemini can read hundreds of files simultaneously. Let it.
...
This tells Gemini Code to inline the file content, guaranteeing it's in context.
