...
- "Create new" → Ask: "Describe what you want gemini to be able to do" (plain text input)
...
<step name="6_gemini_code_install">
<title>Install in Gemini Code</title>
...
Validation: [references/validation-checkpoints.md#gemini-code-install](../references/validation-checkpoints.md#gemini-code-install)
</step>

<step name="7_gemini_desktop_install">
<title>Install in gemini Desktop</title>

Read: [references/creation-workflow.md](../references/creation-workflow.md) → Step 6

Update `~/Library/Application Support/gemini/gemini_desktop_config.json`

Validation: [references/validation-checkpoints.md#gemini-desktop-config](../references/validation-checkpoints.md#gemini-desktop-config)
</step>
...
- No errors in logs: `~/Library/Logs/gemini/mcp-server-{name}.log`
</final_checklist>
...
- `gemini mcp list` shows ✓ Connected
- No errors in logs
</success_criteria>
