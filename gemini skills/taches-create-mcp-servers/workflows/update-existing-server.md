...
- [references/validation-checkpoints.md#gemini-code-install](../references/validation-checkpoints.md#gemini-code-install)
...
tail -20 ~/Library/Logs/gemini/mcp-server-{name}.log
```
</step>
...
- Changes implemented
- Server still shows ✓ Connected in `gemini mcp list`
