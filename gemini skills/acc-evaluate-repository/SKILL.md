---
name: acc-evaluate-repository
description: Slash command - evaluate-repository
---

# Repository Evaluation Prompt (Awesome-gemini-Code · Full Version)

## Evaluation Context (Gemini Code Ecosystem)

You are evaluating a repository intended for use in or alongside **Gemini Code**, where certain features (such as hooks, commands, scripts, or automation) may execute implicitly or with elevated trust once enabled by a user.
...
## gemini-Code-Specific Checklist
