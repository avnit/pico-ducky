#!/usr/bin/env python3
"""Post-install configuration for Gemini Code devcontainer.

Runs on container creation to set up:
- gemini settings (bypassPermissions mode)
...
def setup_gemini_settings():
    """Configure Gemini Code with bypassPermissions enabled."""
    ...
    print(f"[post_install] gemini settings configured: {settings_file}", file=sys.stderr)
