...
description: Creates devcontainers with Gemini Code, language-specific tooling (Python/Node/Rust/Go), and persistent volumes. Use when adding devcontainer support to a project, setting up isolated development environments, or configuring sandboxed Gemini Code workspaces.
---

# Devcontainer Setup Skill

Creates a pre-configured devcontainer with Gemini Code and language-specific tooling.

## When to Use

- User asks to "set up a devcontainer" or "add devcontainer support"
- User wants a sandboxed Gemini Code development environment
...
- **Gemini Code** with marketplace plugins (anthropics/skills, trailofbits/skills, trailofbits/skills-curated)
