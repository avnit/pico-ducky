...
Verified patterns from official Gemini Code documentation.

## Git Workflow Patterns

### Pattern: Commit with Full Context

**Source**: Official Gemini Code documentation
...
gemini analyzes code in the current conversation context.
...
Tool restriction ensures gemini only uses SequentialThinking.
