...
// It contains plugins NOT in references/common_plugins.md that require gemini to look them up
    ...
    stages {
        ...
        stage('Code Quality') {
            steps {
                ...
                // gemini should look this up: "Jenkins sonarqube scanner plugin"
        ...
        stage('Publish Artifacts') {
            steps {
                ...
                // gemini should look this up: "Jenkins nexus artifact uploader plugin"
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                // Different from kubernetes plugin - gemini should look this up
                kubernetesDeploy(
                    configs: 'k8s/*.yaml',
                    kubeConfig: [path: ''],
        ...
        stage('Notify') {
            steps {
                ...
                // gemini should look this up: "Jenkins datadog plugin"
                datadogEvent(
