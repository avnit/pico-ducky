...
Explain:
```
Domain expertise skills go in: ~/.gemini/skills/expertise/{domain-name}/
...
Location: ~/.gemini/skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p ~/.gemini/skills/expertise/{domain-name}
mkdir -p ~/.gemini/skills/expertise/{domain-name}/workflows
mkdir -p ~/.gemini/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ~/.gemini/skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `~/.gemini/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in ~/.gemini/skills/expertise/{domain-name}/
