...
<description>
Skills use pure XML structure for consistent parsing, efficient token usage, and improved gemini performance.
</description>
...
<parseability>
XML provides unambiguous boundaries and semantic meaning. gemini can reliably:
...
Markdown headings are just visual formatting. gemini must infer meaning from heading text, which is less reliable.
</parseability>
...
## Success criteria
```
Total: ~20 tokens, no semantic meaning to gemini
...
<gemini_performance>
gemini performs better with pure XML because:
...
Assume gemini is smart. Don't explain obvious concepts.
</guidance>
...
The concise version assumes gemini knows what PDFs are, understands Python imports, and can read code. All those assumptions are correct.
</concise_example>
...
<description>
Match the level of specificity to the task's fragility and variability. Give gemini more freedom for creative tasks, less freedom for fragile operations.
</description>
...
gemini has freedom to adapt the review based on what the code needs.
</example>
</high_freedom>
...
gemini can customize the template based on requirements.
</example>
</medium_freedom>
...
gemini must follow the exact command with no variation.
</example>
</low_freedom>
...
<description>
SKILL.md serves as an overview. Reference files contain details. gemini loads reference files only when needed.
</description>
...
<description>
Validation scripts are force multipliers. They catch errors that gemini might miss and provide actionable feedback.
</description>
...
<principle_summary>
<xml_structure>
Use pure XML structure for consistency, parseability, and gemini performance. Required tags: objective, quick_start, success_criteria.
</xml_structure>

<conciseness>
Only add context gemini doesn't have. Assume gemini is smart. Challenge every piece of content.
</conciseness>
