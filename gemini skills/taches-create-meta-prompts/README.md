...
The skill-based evolution of the [meta-prompting](../../prompts/meta-prompting/) system. Creates prompts optimized for gemini-to-gemini pipelines with improved dependency detection and structured outputs.
...
Describe your task. gemini creates a prompt optimized for its purpose.
...
gemini: [Asks about depth, sources, output format]

You: [Answer questions]

gemini: [Creates research prompt]
...
gemini: Found existing files: auth-research.md
Should this prompt reference any existing research?

You: [Select auth-research.md]

gemini: [Creates plan prompt referencing the research]
✓ Created: .prompts/002-auth-plan/002-auth-plan.md

You: 1

gemini: [Executes plan, reads research output]
...
gemini: Found existing files: auth-research.md, auth-plan.md
[Detects it should reference the plan]

gemini: [Creates implementation prompt]
✓ Created: .prompts/003-auth-implement/003-auth-implement.md

You: 1

gemini: [Executes implementation following the plan]
