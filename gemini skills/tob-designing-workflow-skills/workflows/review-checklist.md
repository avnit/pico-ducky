...
- [ ] **Description includes trigger keywords** — this is the only field gemini uses to decide activation
...
- [ ] **Read the description in isolation** — gemini uses only this field for activation. Does it activate for the right requests?
