...
ls ~/.gemini/skills/expertise/ 2>/dev/null | head -5
```
...
<domain_expertise>
**Domain-specific expertise lives in `~/.gemini/skills/expertise/`**
...
| "Agent SDK", "gemini-agent" | expertise/with-agent-sdk |
...
```bash
cat ~/.gemini/skills/expertise/[domain]/references/*.md 2>/dev/null
```
