...
- `reason`: Why gemini should continue (required if blocking)
- `continue`: If true and blocking, gemini continues working
- `stopReason`: Message shown when stopping is blocked
- `systemMessage`: Additional context for gemini
