...
(Note: Gemini Code tools are PascalCase by convention, so this is rarely needed)
...
Run `gemini --debug` and watch tool calls to discover available tool names.
