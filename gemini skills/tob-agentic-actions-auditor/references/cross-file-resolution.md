...
5. gemini executes with tainted prompt -- attacker achieves prompt injection
```
...
5. gemini executes with tainted prompt via pull_request_target (has secrets access)
```
